package com.projecki.fusion.component;
...
public class ComponentBuilder {
     ...
     * @return A builder with the passed in formattable content
     */
    public static ComponentBuilder builder(String content, boolean legacy) {
     ...
     * @return A builder with the passed in formattable content
     */
    public static ComponentBuilder builder(String content, TextColor color) {
     ...
     * @return A builder with the passed in formattable content
     */
    public static ComponentBuilder builder(String content, TextColor color, boolean legacy) {
     ...
     */
    public static ComponentBuilder builder(Component component) {
     ...
     * @return A builder with the passed in formattable content
     */
    public static ComponentBuilder builder(String content, TextDecoration decoration) {
     ...
     * @return A builder with the passed in formattable content
     */
    public static ComponentBuilder builder(String content, TextDecoration decoration, boolean legacy) {
     ...
     * @return A builder with the passed in formattable content
     */
    public static ComponentBuilder builder(String content, TextColor color, TextDecoration decoration) {
     ...
     * @return A builder with the passed in formattable content
     */
    public static ComponentBuilder builder(String content, TextColor color, TextDecoration decoration, boolean legacy) {
     ...
     */
    public ComponentBuilder prefix(String prefix) {
     ...
     * @return this builder instance
     */
    public ComponentBuilder prefix(String prefix, boolean legacy) {
     ...
     * @return this builder instance
     */
    public ComponentBuilder prefix(String prefix, TextColor color) {
     ...
     * @return this builder instance
     */
    public ComponentBuilder prefix(String prefix, TextColor color, boolean legacy) {
        this.component = Component.empty()
     ...
     * @return this builder instance
     */
    public ComponentBuilder prefix(String prefix, TextColor color, TextDecoration decoration) {
     ...
     * @return this builder instance
     */
    public ComponentBuilder prefix(String prefix, TextColor color, TextDecoration decoration, boolean legacy) {
        this.component = Component.empty()
                .append(legacy ?
     ...
     * @return this builder instance
     */
    public ComponentBuilder prefix(String prefix, TextDecoration decoration) {
     ...
     * @return this builder instance
     */
    public ComponentBuilder prefix(String prefix, TextDecoration decoration, boolean legacy) {
        this.component = Component.empty()
     ...
     * @return this builder instance
     */
    public ComponentBuilder prefix(Component prefix) {
        this.component = Component.empty()
                .append(prefix)
     ...
     * @return this builder instance
     */
    public ComponentBuilder content(String content, boolean legacy) {
        this.component = Component.empty()
                .append(this.component)
     ...
     * @return this builder instance
     */
    public ComponentBuilder content(Component component) {
        this.component = Component.empty()
                .append(this.component)
                .append(component);
        return this;
     ...
     * @return this builder instance
     */
    public ComponentBuilder content(String content, TextColor color) {
     ...
     * @return this builder instance
     */
    public ComponentBuilder content(String content, TextColor color, boolean legacy) {
        this.component = Component.empty()
                .append(this.component)
                .append(legacy ?
     ...
     * @return this builder instance
     */
    public ComponentBuilder content(String content, TextColor color, TextDecoration decoration) {
     ...
     * @return this builder instance
     */
    public ComponentBuilder content(String content, TextColor color, TextDecoration decoration, boolean legacy) {
        this.component = Component.empty()
                .append(this.component)
                .append(legacy ?
                        LegacyComponentSerializer.legacyAmpersand().deserialize(content).color(color).decorate(decoration) :
     ...
     * @return this builder instance
     */
    public ComponentBuilder content(String content, TextDecoration decoration) {
     ...
     * @return this builder instance
     */
    public ComponentBuilder content(String content, TextDecoration decoration, boolean legacy) {
        this.component = Component.empty()
                .append(this.component)
                .append(legacy ?
     ...
     * @return this builder instance
     */
    public ComponentBuilder replace(String placeholder, Component replacement) {
     ...
     * @return this builder instance
     */
    public ComponentBuilder replace(String placeholder, String replacement) {
     ...
     * @return this builder instance
     */
    public ComponentBuilder replace(String placeholder, String replacement, boolean legacy) {
