...
public record BlockVector2(int x, int z) {
    ...
    /**
     * A comparator for IntVector2ds that orders the vectors by rows, with x as the
    ...
    public int get(int index) {
        return switch (index) {
            case 0 -> x;
            case 1 -> z;
            default -> throw new IllegalArgumentException("invalid index (not 0-1): " + index);
        };
    }
     ...
     * <p>
     * This is equivalent to {@code vector.equals(IntVector2.at(x, z))}
     * only without creating a new IntVector2 object.
     *
